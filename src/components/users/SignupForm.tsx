...
export default function SignupForm() {
    ...
    const [passwordCongirmation, setPasswordCongirmation] = useState<string>("");
    ...
    return (
        <form onSubmit={onsubmit} className='form form--lg'>
            ...
            <dl className='form__block'>
                <dt><label htmlFor="password_confirmation">비밀번호 확인</label></dt>
                <dd><input type="password" name="password_confirmation" id="password_confirmation" required value={passwordCongirmation} onChange={onChange} /></dd>
            </dl>
            ...
            <div className='form__block'>
                <button type='submit' className='form__btn--submit' disabled={error?.length > 0}>이메일 회원가입</button>
            </div>
            <div className='form__block'>
                <button type='button' name="google" className='form__btn--google' onClick={onClickSocialLogin} >구글로 회원가입</button>
            </div>
            <div className='form__block'>
                <button type='button' name="github" className='form__btn--github' onClick={onClickSocialLogin} >깃헙으로 회원가입</button>
            </div>
        </form>
    )
}
